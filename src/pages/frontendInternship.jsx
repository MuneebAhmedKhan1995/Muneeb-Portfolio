...
const FrontendInternshipCertificatePage = () => {
  // ✅ USE EXACT PATH FROM CONSOLE
  const certificates = [
    "/images/resume/frontend.png",
  ];
    ...
    <section className="min-h-screen pt-24 pb-12 bg-gradient-to-b from-indigo-500 to-purple-700">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-white mb-8 text-center">
          My Frontend Development Internship Certificate
        </h1>
...
export default FrontendInternshipCertificatePage;
